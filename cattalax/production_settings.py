...
import os, sys
db_pw = 'the power to do what is right' #os.environ['CAT_PW']
amw_email_pw = 'alea iacta est' # os.environ['AMW_EMAIL_PWD']
...
SITE_URL = 'www.cattalax.com' # os.environ['ALLAMEW_SITE_ID']

# Absolute path to the directory static files should be collected to.
# Don't put anything in this directory yourself; store your static files
# in apps' "static/" subdirectories and in STATICFILES_DIRS.
# Example: "/home/media/media.lawrence.com/static/"
STATIC_ROOT = '/var/www/cattalax.com/static/' 
...
# cwd=os.getcwd()
template_directory = '/var/www/cattalax.com/cattalax/templates'  # cwd + '/templates'
