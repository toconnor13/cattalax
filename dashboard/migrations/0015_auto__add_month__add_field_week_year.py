...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Month'
        db.create_table(u'dashboard_month', (
            ...
            ('month_no', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'dashboard', ['Month'])

        # Adding field 'Week.year'
        db.add_column(u'dashboard_week', 'year',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'dashboard_month')

        # Deleting field 'Week.year'
        db.delete_column(u'dashboard_week', 'year')
