...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Month.datetime'
        db.add_column(u'dashboard_month', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 8, 30, 0, 0)),
                      keep_default=False)

        # Adding field 'Week.datetime'
        db.add_column(u'dashboard_week', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 8, 30, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Month.datetime'
        db.delete_column(u'dashboard_month', 'datetime')

        # Deleting field 'Week.datetime'
        db.delete_column(u'dashboard_week', 'datetime')
