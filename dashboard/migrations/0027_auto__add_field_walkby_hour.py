...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Walkby.hour'
        db.add_column(u'dashboard_walkby', 'hour',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=54, to=orm['dashboard.Hour']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Walkby.hour'
        db.delete_column(u'dashboard_walkby', 'hour_id')
