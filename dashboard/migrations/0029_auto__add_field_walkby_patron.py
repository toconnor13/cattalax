...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Walkby.patron'
        db.add_column(u'dashboard_walkby', 'patron',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=50, to=orm['dashboard.Customer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Walkby.patron'
        db.delete_column(u'dashboard_walkby', 'patron_id')
