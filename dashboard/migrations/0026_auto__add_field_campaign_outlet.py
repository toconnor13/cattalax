...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.outlet'
        db.add_column(u'dashboard_campaign', 'outlet',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['dashboard.Outlet']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.outlet'
        db.delete_column(u'dashboard_campaign', 'outlet_id')
