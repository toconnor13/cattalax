...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Visit.arrival_time'
        db.delete_column(u'dashboard_visit', 'arrival_time')


    def backwards(self, orm):
        # Adding field 'Visit.arrival_time'
        db.add_column(u'dashboard_visit', 'arrival_time',
