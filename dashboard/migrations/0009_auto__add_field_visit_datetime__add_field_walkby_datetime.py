...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visit.datetime'
        db.add_column(u'dashboard_visit', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 5, 0, 0)),
                      keep_default=False)

        # Adding field 'Walkby.datetime'
        db.add_column(u'dashboard_walkby', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 5, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visit.datetime'
        db.delete_column(u'dashboard_visit', 'datetime')

        # Deleting field 'Walkby.datetime'
        db.delete_column(u'dashboard_walkby', 'datetime')
