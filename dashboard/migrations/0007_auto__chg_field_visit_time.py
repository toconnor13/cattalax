...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Visit.time'
        db.alter_column(u'dashboard_visit', 'time', self.gf('django.db.models.fields.IntegerField')(default=23))

    def backwards(self, orm):

        # Changing field 'Visit.time'
        db.alter_column(u'dashboard_visit', 'time', self.gf('django.db.models.fields.IntegerField')(null=True))
