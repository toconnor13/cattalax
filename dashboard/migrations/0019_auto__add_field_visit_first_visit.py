...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visit.first_visit'
        db.add_column(u'dashboard_visit', 'first_visit',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visit.first_visit'
        db.delete_column(u'dashboard_visit', 'first_visit')
