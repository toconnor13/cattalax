...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Walkby.addr'
        db.add_column(u'dashboard_walkby', 'addr',
                      self.gf('django.db.models.fields.CharField')(default='00:00:00:00:00:00', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Walkby.addr'
        db.delete_column(u'dashboard_walkby', 'addr')
